                ...
                <div class="col-lg-4">
                    <div class="footer-widgets_info">
                        ...
                        <div class="footer-widgets_logo">
                            <a href="#">
                                <img src="{{ asset('user/images/footer/logo/2.png') }}" alt="Hiraola's Footer Logo">
                            </a>
                        </div>
                            ...
                            <div class="col-lg-5">
                                <div class="footer-widgets_info">
                                    ...
                                    <div class="widgets-essential_stuff">
                                        <ul>
                                            <li class="hiraola-address"><i class="ion-ios-location"></i><span>Address:</span> The Barn,
                                                Ullenhall, Henley
                                                in
            ...
            <div class="footer-bottom_nav">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="payment">
                            <a href="#">
                                <img src="{{ asset('user/images/footer/payment/1.png') }}" alt="Hiraola's Payment Method">
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-12">
