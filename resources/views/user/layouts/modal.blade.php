                                ...
                                <div class="sp-img_area">
                                    ...
                                    "asNavFor": ".sp-img_slider-nav"
                                        ...
                                        <div class="single-slide red">
                                            <img src="{{ asset('user/images/single-product/large-size/1.jpg') }}" alt="Hiraola's Product Image">
                                        </div>
                                        <div class="single-slide orange">
                                            <img src="{{ asset('user/images/single-product/large-size/2.jpg') }}" alt="Hiraola's Product Image">
                                        </div>
                                        <div class="single-slide brown">
                                            <img src="{{ asset('user/images/single-product/large-size/3.jpg') }}" alt="Hiraola's Product Image">
                                        </div>
                                        <div class="single-slide umber">
                                            <img src="{{ asset('user/images/single-product/large-size/4.jpg') }}" alt="Hiraola's Product Image">
                                        </div>
                                    </div>
                                   ...
                                   "focusOnSelect": true
                                        ...
                                        <div class="single-slide red">
                                            <img src="{{ asset('user/images/single-product/small-size/1.jpg') }}" alt="Hiraola's Product Thumnail">
                                        </div>
                                        <div class="single-slide orange">
                                            <img src="{{ asset('user/images/single-product/small-size/2.jpg') }}" alt="Hiraola's Product Thumnail">
                                        </div>
                                        <div class="single-slide brown">
                                            <img src="{{ asset('user/images/single-product/small-size/3.jpg') }}" alt="Hiraola's Product Thumnail">
                                        </div>
                                        <div class="single-slide umber">
                                            <img src="{{ asset('user/images/single-product/small-size/4.jpg') }}" alt="Hiraola's Product Thumnail">
                                        </div>
                                    </div>
                                </div>
                            </div>
